...
public class EcommerceApplicationIntegrationTest {
    ...
    public void givenGetProductsApiCall_whenProductListRetrieved_thenSizeMatchAndListContainsProductNames() {
        ...
        assertThat(products, hasItem(hasProperty("name", is("A"))));
        assertThat(products, hasItem(hasProperty("name", is("B"))));
        assertThat(products, hasItem(hasProperty("name", is("C"))));
        assertThat(products, hasItem(hasProperty("name", is("D"))));
    }
    ...
    private OrderController.OrderForm prepareOrderForm() {
        ...
        productDto.setProduct(new Product(1L, "A", 50.00, "http://placehold.it/200x100"));
